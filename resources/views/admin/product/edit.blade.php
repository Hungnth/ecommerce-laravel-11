        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="flex align-content-center">Update Product</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label for="" class="mt-3 mb-2">Image</label>
                        ...
                        <div class="form-group">
                            <div class="flex">
                                @foreach($product->images as $image)
                                    <img style="width: 100px!important;" class="ms-2 me-2 mt-2" src="{{ asset($image->path) }}" alt="">
                                @endforeach
                            </div>
                            <label for="" class="mt-3 mb-2">Images</label>
                            <x-text-input type="file" class="form-control" name="images[]" multiple/>
                        </div>

                        <div class="form-group">
                            <label for="" class="mt-3 mb-2">Name</label>
                            <x-text-input type="text" class="form-control" name="name" value="{{ $product->name }}"/>
                        </div>

                        <div class="form-group">
                            <label for="" class="mt-3 mb-2">Price</label>
                            <x-text-input type="text" class="form-control" name="price" value="{{ $product->price }}"/>
                        </div>

                        <div class="form-group">
                            <label for="" class="mt-3 mb-2">Colors</label>
                        ...
                        <x-primary-button class="mt-3 mb-2">Submit</x-primary-button>
                    </form>
                </div>
            </div>
        </div>
